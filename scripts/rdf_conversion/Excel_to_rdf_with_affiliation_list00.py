...
# === 6. Iterate through rows and add RDF triples ===
unmatched_orgs = []
...
output_file = os.path.join(_ROOT, "data", "rdf", "abstracts_katalytikertagung_w_affili.ttl")
g.serialize(destination=output_file, format="turtle")

print(f"\n✅ RDF graph written to {output_file}")

# === 8. Report unmatched organizations ===
if unmatched_orgs:
