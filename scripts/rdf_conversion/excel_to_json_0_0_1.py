...
# --- Configuration ---
INPUT_EXCEL_FILE = os.path.join(_ROOT, 'data', 'intermediate', 'metadata_accaptable_for_llm.xlsx')
OUTPUT_JSON_FILE = os.path.join(_ROOT, 'data', 'intermediate', 'metadata_accaptable_for_llm.json')
