...
def main():
    # File paths
    affiliation_groups_file = os.path.join(_ROOT, 'data', 'intermediate', 'affiliation_groups2.json')
    metadata_file = os.path.join(_ROOT, 'data', 'intermediate', 'metadata_output_20251023_1016_cleaned_affiliations2.json')
    output_file = os.path.join(_ROOT, 'data', 'intermediate', 'metadata_output_20251023_1016_cleaned_affiliations3.json')
