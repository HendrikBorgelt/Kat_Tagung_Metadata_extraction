...
if __name__ == "__main__":
    ...
    input_file = os.path.join(_ROOT, "data", "intermediate", "metadata_output_20251023_1016_cleaned_affiliations3.json")
    output_file = os.path.join(_ROOT, "data", "intermediate", "affiliation_groups3.json")
